...
class ShimmerLoadingTeacherAdmin extends StatelessWidget {
  const ShimmerLoadingTeacherAdmin({super.key});

  @override
  Widget build(BuildContext context) {
    return SectionCard(title: 'Teachers',
          isNotShowColorSvg:false,
        icon: 'assets/svgs/type_of_teaching.svg', widget: Shimmer.fromColors(
