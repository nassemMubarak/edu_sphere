...
class ContactUsSubscribePage extends StatelessWidget {
  const ContactUsSubscribePage({super.key});
            ...
            Container(
              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      SvgPicture.asset('assets/svgs/permanet_icon.svg',width: 24.w,height: 24.h),
                      horizontalSpace(8),
                      Expanded(child: Text('Subscribe to the package',style: TextStyles.font16Black500Weight,)),
                    ],
                  ),
                  verticalSpace(24),
                  Text('If you wish to subscribe to the package, contact us through our accounts',style: TextStyles.font14Black400Weight,),
                ],
              ),
            ),
            verticalSpace(24),
