...
class ShowCoursesStudentAdminWidget extends StatelessWidget {
  StudentInformationModel studentInformationModel;
  ShowCoursesStudentAdminWidget({
    super.key,
     required this.studentInformationModel
  });

  @override
  Widget build(BuildContext context) {
    return studentInformationModel.courses.isNotEmpty?SectionCard(
      ...
      widget: ListView.builder(
        ...
        itemCount: studentInformationModel.courses.length,
        itemBuilder: (context, index) => Container(
          margin: const EdgeInsets.only(bottom: 16),
          child: ListTile(
            contentPadding: const EdgeInsets.only(left: 0.0, right: 0.0),
            title: Text(
              studentInformationModel.courses[index].title,
            ...
            subtitle: Text(
              studentInformationModel.courses[index].description,
