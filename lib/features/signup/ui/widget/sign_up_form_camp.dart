...
class SignUpFormCamp extends StatefulWidget {
  const SignUpFormCamp({super.key});

  @override
  State<SignUpFormCamp> createState() => _EmailAndPasswordWidgetState();
}

class _EmailAndPasswordWidgetState extends State<SignUpFormCamp> {
  ...
  late TextEditingController campTextEditingController;
  ...
  void initState() {
    ...
    campTextEditingController = TextEditingController();
  }
