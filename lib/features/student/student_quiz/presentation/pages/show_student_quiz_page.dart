...
class ShowStudentQuizPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    context.read<StudentQuizCubit>().emitGetAttemptStudentQuizUseCase(idCourse: coursesModel!.id, idQuiz: quiz.id);
    return SliverWidget(
