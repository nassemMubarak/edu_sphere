...
class EstimateQuizPage extends StatelessWidget {
  const EstimateQuizPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    var quiz = context
        .read<QuizCubit>()
        .quize;
    context.read<QuizCubit>().emitGetAllEstimateQuiz(idQuiz: quiz!.id,idCourse:coursesModel.id );
    return Scaffold(
