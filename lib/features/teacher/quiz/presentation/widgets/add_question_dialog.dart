...
import 'package:edu_sphere/features/teacher/quiz/presentation/widgets/add_options_widget.dart';
import 'package:edu_sphere/features/teacher/quiz/presentation/widgets/upload_image_widget.dart';
                ...
                child: AppTextButton(
                  onPressed: () {
                    if (context
                      ...
                      context.read<QuizCubit>().emitAddQuestionToQuiz(context);
                      context.pop();
                    }
