...
abstract class TeacherMainLocalDataSource {
  Future<List<CourseModel>> getLocalCourses();
  Future<Unit> saveCourses({required List<CourseModel> listCourses});
}

class TeacherMainLocalDataSourceImpl implements TeacherMainLocalDataSource {
  @override
  ...
  @override
  Future<Unit> saveCourses({required List<CourseModel> listCourses}) async {
    try {
