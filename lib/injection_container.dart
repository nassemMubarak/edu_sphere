...
Future<void> init() async {
  ...
  /// quiz
  /// course quiz
  sl.registerFactory(()=>QuizCubit(getAllEstimateQuizUseCase: sl(),updateEstimateQuizUseCase: sl(),getAllQuizUseCase: sl(), addQuizUseCase: sl(), updateQuizUseCase: sl(), deleteQuizUseCase: sl()));
  /// question quiz
